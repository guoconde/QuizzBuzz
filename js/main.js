        ...
        screenTwo.innerHTML +=
            ...
            <div class="form-Field hide">
                <div class="form">
                    ...
                    <br>
                    <input class='no-mandatory wrong-answer' type="text" placeholder="Resposta incorreta 2" data-identifier="question">
                    <p class = 'error wrong-answer'> </p>
                    <input class='no-mandatory url-wrong-answer' type="text" placeholder="URL da imagem 2" data-identifier="question">
                    <p class = 'error image-wrong'> </p>
                    <br>
                    <input class='no-mandatory wrong-answer' type="text" placeholder="Resposta incorreta 3" data-identifier="question">
                    <p class = 'error wrong-answer'> </p>
                    <input class='no-mandatory url-wrong-answer' type="text" placeholder="URL da imagem 3" data-identifier="question">
                    <p class = 'error image-wrong'> </p>
                </div>
            </div>`
    }
